<!-- This page for when the adminstrator logs in-->
<html>
<head lang="en">
    <meta charset="UTF-8">
...
if(isset($_POST['admin_login']))//this will tell us what to do if some data has been post through form with button.
{
    ...
    //if query pulls up something then continue else evade situation
    if(mysqli_num_rows($run_query)>0)
    {

        echo "<script>window.open('view_users.php','_self')</script>";
    }
    else {echo"<script>alert('Password is not right')</script>";}
